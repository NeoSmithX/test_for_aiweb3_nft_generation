...
async function main(){
    let inputData: my_interface.GradioInput = {
        ...
        style_image: './test_files/style.png',
        sketch_image: './test_files/sketch.jpg',
        color_image: './test_files/color.png',
        depth_image: './test_files/depth.png',
        canny_image: './test_files/canny.png',
        condition_weight: 3,
        prompt: 'prompt text',
